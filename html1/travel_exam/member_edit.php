...
<div id="wrap">
    ...
    <?php $email=explode("@",$row["email"]);?>
        ...
        <?php if($row["gendar"]=="m"){?>checked<?php }?>>남성
				<input type="radio" name="gendar" value="f"
        <?php if($row["gendar"]=="f"){?>checked<?php }?>>여성
			</td>
		</tr>
		<tr>
			<td align="right">취미</td>
			<td>
				<input type="checkbox" name="hoby1" value="여행"
        <?php if($row["hoby1"]=="여행"){?>checked<?php }?>>여행
				<input type="checkbox" name="hoby2" value="등산"
        <?php if($row["hoby2"]=="등산"){?>checked<?php }?>>등산
				<input type="checkbox" name="hoby3" value="낚시"
        <?php if($row["hoby3"]=="낚시"){?>checked<?php }?>>낚시
				<input type="checkbox" name="hoby4" value="영화"
        <?php if($row["hoby4"]=="영화"){?>checked<?php }?>>영화
				<input type="checkbox" name="hoby5" value="음악"
        <?php if($row["hoby5"]=="음악"){?>checked<?php }?>>음악
			</td>
		</tr>
		<tr>
