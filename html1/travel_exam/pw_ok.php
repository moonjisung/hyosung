<?php
    ...
    $email=$_POST["email2"];
    $id=$_POST["id"];
$query="select * from member2 where name='$name' and email='$email' and id='$id'";
...
<div id="wrap">
	<br><br><br>
  <div style="width:300px;height:150px;border-top:3px solid #4298cc;border-bottom:3px
   solid #4298cc; background-color:#dde7dd;padding:30px;font-size:0.9em;color:#666; text-align:center;">
  <?php echo $pw ?>
  <a href="idpw.php">
    <br>-메인으로 가기-</a>
  </div>
