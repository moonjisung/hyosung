...
<div id="wrap">
	...
	<table class="table1" width="600px">
		...
		<tr>
			...
			<td>
				<input type="radio" name="gendar" value="m" checked>남성
				<input type="radio" name="gendar" value="f">여성
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="hoby3" value="낚시">낚시
				<input type="checkbox" name="hoby4" value="영화">영화
				<input type="checkbox" name="hoby5" value="음악">음악
			</td>
		</tr>
		<tr>
