...
<form action=insert.php method=post name=fm onsubmit="return FormCheck()" enctype="multipart/form-data">
...
<tr>
	<td bgcolor=white>&nbsp;
		...
		<tr>
			...
			<td align=left >
			<INPUT type=password name=pass size=8 maxlength=8 AUTOCOMPLETE="OFF"> (수정,삭제시 반드시 필요)
			</td>
		</tr>
		<tr>
